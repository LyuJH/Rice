...
int main() { 
  std::string label_path = "/opt/labels/pascalvoc_label_list";
  ...
  cxx_config.set_model_file("/opt/model/__model__");
  cxx_config.set_param_file("/opt/model/__params__");
  ...
  std::string output_image_path = "/opt/steel_images/47_result.jpg";
